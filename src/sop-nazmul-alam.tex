...
\ifshowsections\tabsection{Academic Journey}\fi
...
\ifshowsections\tabsection{Programming Contest Experience}\fi
...
\ifshowsections\tabsection{Personal Resilience and Sacrifices}\fi
...
\ifshowsections\tabsection{Professional Experience}\fi
...
\ifshowsections\tabsection{Research Interests}\fi
...
\ifshowsections\tabsection{Motivation and Future Goals}\fi
...
\ifshowsections\tabsection{Conclusion}\fi
