...
\usepackage{sopstyle} % This now loads your style plus the header.
...
\ifshowsections\sopsection{Introduction}\fi
...
\ifshowsections\sopsection{Academic Journey}\fi
...
\ifshowsections\sopsection{Programming Contest Experience}\fi
...
\ifshowsections\sopsection{Personal Resilience and Sacrifices}\fi
...
\ifshowsections\sopsection{Professional Experience}\fi
...
\ifshowsections\sopsection{Research Interests}\fi
...
\ifshowsections\sopsection{Motivation and Future Goals}\fi
...
\ifshowsections\sopsection{Conclusion}\fi
